...
<template>
  ...
  <div class="bg-gray-50 w-full py-12 lg:px-32 px-4">
    <p class="text-center py-8 mx-auto md:w-1/2">
      Prenez contact avec nous, Que vous ayez une question sur les traitements,
      les factures, l'assurance médicale veuillez nous contacter en utilisant
    ...
    <div class="w-full lg:flex">
      <div class="lg:w-1/2 px-6">
        ...
        >
          <p class="font-bold text-lg">Google Map</p>
        </div>
        <div class="mt-8 flex flex-col items-start justify-start space-y-4">
          <a
            href="#"
            class="flex justify-center items-center space-x-2 hover:underline font-semibold"
          >
            <div
              class="p-2 rounded-lg border-2 border-title text-title flex justify-center items-center"
            >
              <EnvelopeIcon class="h-8 w-8" />
            </div>
            <div>drsigha@yahoo.fr</div>
          </a>
          <a
            href="#"
            class="flex justify-center items-center space-x-2 hover:underline font-semibold"
          >
            ...
            <div>Douala, Bounamoussadi maison verte</div>
          </a>
          <a
            href="#"
            class="flex justify-center items-center space-x-2 hover:underline font-semibold"
          >
            ...
            <div>Médécine Esthétique au Cameroun</div>
          </a>
          <a
            href="#"
            class="flex justify-center items-center space-x-2 hover:underline font-semibold"
          >
            ...
            <div
              class="p-2 rounded-lg border-2 border-title text-title flex justify-center items-center"
            >
              <PhoneArrowUpRightIcon class="h-8 w-8" />
            </div>
            <div>237 6 58 40 11 81</div>
          </a>
        </div>
      </div>
      <div class="lg:w-1/2 px-6 lg:mt-0 mt-6">
        <form class="w-full">
          <div class="grid md:grid-cols-2 gap-6">
            <div>
              <label for="name" class="lg:text-xl font-semibold">Nom</label>
              <div class="relative mt-2">
                <UserIcon class="h-7 w-7 text-title absolute top-3.5 left-3" />
                <input
                  type="text"
                  placeholder="Nom"
                  id="name"
                  class="py-4 text-xl px-2 rounded-xl bg-white w-full pl-12 focus:outline-none focus:border focus:border-white focus:ring focus:ring-custom-yellow/80"
                />
              </div>
            </div>
            <div>
              <label for="email" class="lg:text-xl font-semibold">E-mail</label>
              <div class="relative mt-2">
                <EnvelopeIcon
                  class="h-7 w-7 text-title absolute top-3.5 left-3"
                />
                <input
                  type="email"
                  placeholder="E-mail"
            ...
            <div>
              <label for="phone" class="lg:text-xl font-semibold"
                >Téléphone</label
              >
              <div class="relative mt-2">
                <PhoneIcon class="h-7 w-7 text-title absolute top-3.5 left-3" />
                <input
                  type="text"
                  id="phone"
                  placeholder="Téléphone"
                  class="py-4 text-xl pr-2 rounded-xl bg-white w-full pl-12 focus:outline-none focus:border focus:border-white focus:ring focus:ring-custom-yellow/80"
                />
              </div>
            </div>
            <div>
              <label for="subject" class="lg:text-xl font-semibold"
                >Discipline</label
              >
              <div class="relative mt-2">
                <BookmarkIcon
                ...
                <select
                  name="subject"
                  id="subject"
                  class="py-4 text-xl rounded-xl pr-2 w-full pl-12 focus:outline-none focus:border focus:border-white focus:ring focus:ring-custom-yellow/80"
                >
          ...
          <div class="mt-6">
            <label for="message" class="lg:text-xl font-semibold"
              >Comment Pouvons-nous Vous Aider?</label
            >
            <div class="relative mt-2">
              <PencilIcon class="h-7 w-7 text-title absolute top-3.5 left-3" />
              <textarea
                name="message"
                id="message"
                class="py-4 text-xl rounded-xl pr-2 w-full h-52 pl-12 focus:outline-none focus:border focus:border-white focus:ring focus:ring-custom-yellow/80"
              ></textarea>
            </div>
          </div>
          <div class="mt-10">
            <button
              type="button"
              class="bg-custom-yellow py-4 px-6 w-full border border-title hover:bg-transparent transition-colors hover:text-title rounded-xl"
            >
              Prenez rendez-vous
            </button>
          </div>
